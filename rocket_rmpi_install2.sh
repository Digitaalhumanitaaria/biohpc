...
cd readline-6.3
./configure --prefix=$HOME/$RDIR/readlineinstall \
...
cd R-3.0.0
./configure --prefix=$HOME/$RDIR/R300install \
 CC=$HOME/$MPIDIR/install/bin/mpicc \
 ...
 LDFLAGS="-L$HOME/$RDIR/readlineinstall/lib" \
 CPPFLAGS="-I$HOME/$RDIR/readlineinstall/include" \
--with-x=no
make
make install
cd ..
...
export LD_LIBRARY_PATH=$LD_LIBRARY_PATH:$HOME/$RDIR/R300install/lib64/R/lib:$HOME/$RDIR/R300install/lib64/R/library
...
$HOME/$RDIR/R300install/bin/R CMD INSTALL \
 ...
 --configure-args="--with-Rmpi-include=$MPIINCLUDE \
                   --with-Rmpi-libpath=$MPILIB \
                   --with-Rmpi-type=OPENMPI" \
 -l $HOME/$RDIR/R300install/lib64/R/library iterators_1.0.8.tar.gz
...
$HOME/$RDIR/R300install/bin/R CMD INSTALL \
 ...
 --configure-args="--with-Rmpi-include=$MPIINCLUDE \
                   --with-Rmpi-libpath=$MPILIB \
                   --with-Rmpi-type=OPENMPI" \
 -l $HOME/$RDIR/R300install/lib64/R/library foreach_1.4.3.tar.gz
...
$HOME/$RDIR/R300install/bin/R CMD INSTALL \
 ...
 --configure-args="--with-Rmpi-include=$MPIINCLUDE \
                   --with-Rmpi-libpath=$MPILIB \
                   --with-Rmpi-type=OPENMPI" \
 -l $HOME/$RDIR/R300install/lib64/R/library doParallel_1.0.10.tar.gz
...
$HOME/$RDIR/R300install/bin/R CMD INSTALL \
 ...
 --configure-args="--with-Rmpi-include=$MPIINCLUDE \
                   --with-Rmpi-libpath=$MPILIB \
                   --with-Rmpi-type=OPENMPI" \
 -l $HOME/$RDIR/R300install/lib64/R/library doMPI_0.2.1.tar.gz
...
$HOME/$RDIR/R300install/bin/R CMD INSTALL \
 ...
 --configure-args="--with-Rmpi-include=$MPIINCLUDE \
                   --with-Rmpi-libpath=$MPILIB \
                   --with-Rmpi-type=OPENMPI" \
 -l $HOME/$RDIR/R300install/lib64/R/library doSNOW_1.0.14.tar.gz
...
$HOME/$RDIR/R300install/bin/R CMD INSTALL \
 ...
 --configure-args="--with-Rmpi-include=$MPIINCLUDE \
                   --with-Rmpi-libpath=$MPILIB \
                   --with-Rmpi-type=OPENMPI" \
 -l $HOME/$RDIR/R300install/lib64/R/library snowfall_1.84-6.1.tar.gz
...
$HOME/$RDIR/R300install/bin/R CMD INSTALL \
 ...
 --configure-args="--with-Rmpi-include=$MPIINCLUDE \
                   --with-Rmpi-libpath=$MPILIB \
                   --with-Rmpi-type=OPENMPI" \
 -l $HOME/$RDIR/R300install/lib64/R/library rlecuyer_0.3-4.tar.gz
...
$HOME/$RDIR/R300install/bin/R CMD INSTALL \
 ...
 --configure-args="--with-nc-config=$HOME/$NETCDF4DIR/netcdf4install/bin \
                   ...
                   --with-mpi-libpath=$MPILIB \
                   --with-mpi-type=OPENMPI" \
-l $HOME/$RDIR/R300install/lib64/R/library pbdNCDF4 
...
$HOME/$RDIR/R300install/bin/R CMD INSTALL \
 ...
 --configure-args="--with-mpi-include=$MPIINCLUDE \
                   --with-mpi-libpath=$MPILIB \
                   --with-mpi-type=OPENMPI" \
-l $HOME/$RDIR/R300install/lib64/R/library pbdDEMO_0.3-0.tar.gz
...
$HOME/$RDIR/R300install/bin/R CMD INSTALL \
 ...
 --configure-args="--with-mpi-include=$MPIINCLUDE \
                   --with-mpi-libpath=$MPILIB \
                   --with-mpi-type=OPENMPI" \
-l $HOME/$RDIR/R300install/lib64/R/library chron_2.3-47.tar.gz
